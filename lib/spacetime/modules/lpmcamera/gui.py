...
class CameraFrameGUI(FalseColorImageGUI, CameraGUI, SingleFrameAnimation):
	...
	traits_view = support.PanelView(
		traitsui.Group(
			...
			traitsui.Item('firstframe', label='First frame', editor=traitsui.RangeEditor(low=0, high_name='framecount', mode='spinner', enter_set=True, auto_set=False)),
			traitsui.Item('lastframe', label='Last frame', enabled_when='is_filmstrip', editor=traitsui.RangeEditor(low=0, high_name='framecount', mode='spinner', enter_set=True, auto_set=False)),
			traitsui.Item('stepframe', label='Key frame mode', enabled_when='is_filmstrip', editor=traitsui.RangeEditor(enter_set=True, auto_set=False)),
...
class CameraTrendGUI(DoubleTimeTrendGUI, CameraGUI, XlimitsGUI):
	...
	traits_view = support.PanelView(
		traitsui.Group(
			...
			traitsui.Item('filename', editor=support.FileEditor(filter=['Camera RAW files (*.raw)', '*.raw', 'All files', '*'], entries=0)),
			traitsui.Item('firstframe', label='First frame', editor=traitsui.RangeEditor(low=0, high_name='framecount', mode='spinner', enter_set=True, auto_set=False)),
			traitsui.Item('lastframe', label='Last frame', editor=traitsui.RangeEditor(low=0, high_name='framecount', mode='spinner', enter_set=True, auto_set=False), enabled_when='not_fft'),
			traitsui.Item('stepframe', label='Key frame mode', enabled_when='not_fft', editor=traitsui.RangeEditor(enter_set=True, auto_set=False)),
