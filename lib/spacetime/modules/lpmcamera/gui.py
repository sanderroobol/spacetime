...
class CameraFrameGUI(FalseColorImageGUI, CameraGUI, SingleFrameAnimation):
	...
	traits_view = support.PanelView(
		traitsui.Group(
			...
			traitsui.Item('stepframe', label='Key frame mode', enabled_when='is_filmstrip', editor=support.RangeEditor(low=1, high=1000000000, mode='spinner')),
...
class CameraTrendGUI(DoubleTimeTrendGUI, CameraGUI, XlimitsMixin):
	...
	traits_view = support.PanelView(
		traitsui.Group(
			...
			traitsui.Item('stepframe', label='Key frame mode', enabled_when='not_fft', editor=support.RangeEditor(low=1, high=1000000000, mode='spinner')),
